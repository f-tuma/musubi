...
function _CalendarHeaderForMonthView({
  ...
  return (
    ...
    >
      {showWeekNumber ? (
        <View style={[u['w-20'], { paddingTop: 2 }]} key={'weekNumber'} {...headerCellAccessibilityProps}>
          <View style={{ flex: 1, height: 30 }}>
            <Text style={[u['text-center'], { color: theme.palette.gray['800'] }]}>
      ...
      {dates.map((date) => (
        <View style={{ flex: 1, paddingTop: 2 }} key={date.toISOString()} {...headerCellAccessibilityProps}>
